...
export default function Home({ query }) {
  ...
  return (
    <>
      <Navbar />
      <div className="mx-12 sm:mx-12 md:mx-36 lg:mx-64">
        <Head>
            ...
            <div className="mt-8 relative">
              ...
              <div className=" relative group">
                ...
                <textarea
                  ...
                  ref={textAreaRef}
                  // rows="3"
                  class=" shadow-sm block w-full h-96 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border border-gray-300 rounded-md mt-10"
